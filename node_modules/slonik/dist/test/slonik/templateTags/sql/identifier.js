...
ava_1.default('creates an object describing a query with inlined identifiers', (t) => {
...
ava_1.default('creates an object describing a query with inlined identifiers (specifier)', (t) => {
...
ava_1.default('throws if an identifier name array member type is not a string', (t) => {
